...
// node_modules/.pnpm/@firebase+ai@1.3.0_@firebase+app-types@0.9.3_@firebase+app@0.13.0/node_modules/@firebase/ai/dist/esm/index.esm2017.js
      ...
      if (candidate.safetyRatings) {
        mappedSafetyRatings = candidate.safetyRatings.map((safetyRating) => {
          ...
          return Object.assign(Object.assign({}, safetyRating), {
            severity: (_a2 = safetyRating.severity) !== null && _a2 !== void 0 ? _a2 : HarmSeverity.HARM_SEVERITY_UNSUPPORTED,
...
// node_modules/.pnpm/@angular+fire@19.2.0_@angular+common@19.2.15_@angular+core@19.2.15_@angular+platform-browser-_ptnhjgdhaa3bbt454zv56r6xce/node_modules/@angular/fire/fesm2022/angular-fire-ai.mjs
var AI = class {
  constructor(ai) {
    return ai;
  }
};
var AI_PROVIDER_NAME = "AI";
var AIInstances = class {
  constructor() {
    return ɵgetAllInstancesOf(AI_PROVIDER_NAME);
  }
};
var AIInstance$ = timer(0, 300).pipe(concatMap(() => from(ɵgetAllInstancesOf(AI_PROVIDER_NAME))), distinct());
var PROVIDED_AI_INSTANCES = new InjectionToken("angularfire2.ai-instances");
function defaultAIInstanceFactory(provided, defaultApp) {
  const defaultAI = ɵgetDefaultInstanceOf(AI_PROVIDER_NAME, provided, defaultApp);
...
var AI_INSTANCES_PROVIDER = {
  provide: AIInstances,
  deps: [[new Optional(), PROVIDED_AI_INSTANCES]]
};
var DEFAULT_AI_INSTANCE_PROVIDER = {
  provide: AI,
...
@firebase/ai/dist/esm/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=@angular_fire_ai.js.map
